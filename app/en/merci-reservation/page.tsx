...
export const metadata: Metadata = {
  title: "Booking Request Received - MCS Limo",
  description: "Thank you for your reservation. The MCS Limo team will confirm your trip shortly.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function EnMerciReservationPage() {
  return (
    <div id="page" className="site">
      ...
      <MainHeader lang="en" currentPath="/en/merci-reservation" />
